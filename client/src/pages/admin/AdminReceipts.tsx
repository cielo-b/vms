...
import { fetchReceipts } from "../../features/admin/admin.slice";

const AdminReceiptsPage = () => {
  const dispatch = useAppDispatch();
  const { receipts, loading, error } = useAppSelector((state) => state.admin);
  ...
  const handleExport = () => {
    exportToExcel(receipts, "all_receipts");
  };
